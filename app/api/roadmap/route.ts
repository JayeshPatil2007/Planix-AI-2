...
export async function POST(request: Request) {
  try {
    ...
    if (data.action === 'refine') {
      const updatedRoadmap = await refineRoadmap(data.currentRoadmap, data.prompt, data.uploadedContext, data.chatHistory, data.userProgress);
